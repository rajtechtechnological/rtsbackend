from sqlalchemy import Column, String, Boolean, DateTime, ForeignKey, CheckConstraint, Index, Integer, text
...
class User(Base):
    ...
    # Brute-force lockout (docs/01 §5): DB-backed so it works on serverless.
